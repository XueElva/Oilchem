...
import net.oilchem.communication.sms.receiver.AlarmReceiver;
...
abstract public class WakefulIntentService extends IntentService {
	...
	public static final String NAME = "com.haobao.wardrobe.service.PullNotificationService";
	...
	final protected void onHandleIntent(Intent intent) {
		try {
			doWakefulWork(this.getApplicationContext(), intent);
		} finally {
